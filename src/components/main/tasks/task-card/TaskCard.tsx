...
export default function TaskCard({ taskName }: TaskCardProps) {
  return (
    <div className="w-full flex justify-between p-4 bg-gray-500 hover:bg-gray-500/80 transition-all rounded-lg border border-solid border-gray-500">
      <input
        ...
        type="checkbox"
      />
      <span className="text-gray-100 px-3 flex-1">{taskName}</span>
